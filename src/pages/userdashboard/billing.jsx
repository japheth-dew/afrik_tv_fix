...
const Dashboard = () => {
  return (
    ...
    <><div class="px-4 py-2 border-b-2 border-white bg-green-700">
          <nav class="flex w-full">
              ...
              <div class="flex justify-end w-1/3">
                  <div class="flex space-x-4">
                      <a
                          href="#"
                          class="text-lg font-semibold text-white hover:bg-green-900 px-3 py-1 rounded-xl hover:shadow-xl"
                      >Profile</a><a
                          href="#"
                          class="text-lg font-semibold text-white hover:bg-green-900 px-3 py-1 rounded-xl hover:shadow-xl"
                      >Logout</a>
      ...
      <div class="flex">
              <nav
                  class="w-1/2 px-4 py-4 space-y-1 border-r md:w-1/3 lg:w-64 md:top-0 md:left-0 bg-green-500"
              >
                  <a
                      href="#"
                      class="text-green-200 hover:bg-green-600 flex items-center py-5 px-4 rounded-xl hover:shadow-xl bg-green-600"
                  ><svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                          <path
                              d="M18.121,9.88l-7.832-7.836c-0.155-0.158-0.428-0.155-0.584,0L1.842,9.913c-0.262,0.263-0.073,0.705,0.292,0.705h2.069v7.042c0,0.227,0.187,0.414,0.414,0.414h3.725c0.228,0,0.414-0.188,0.414-0.414v-3.313h2.483v3.313c0,0.227,0.187,0.414,0.413,0.414h3.726c0.229,0,0.414-0.188,0.414-0.414v-7.042h2.068h0.004C18.331,10.617,18.389,10.146,18.121,9.88 M14.963,17.245h-2.896v-3.313c0-0.229-0.186-0.415-0.414-0.415H8.342c-0.228,0-0.414,0.187-0.414,0.415v3.313H5.032v-6.628h9.931V17.245z M3.133,9.79l6.864-6.868l6.867,6.868H3.133z"
                          ></path></svg><span class="menu-sub-item-text">Dashboard</span></a><a
                              href="#"
                              class="text-green-200 hover:bg-green-600 flex items-center py-5 px-4 rounded-xl hover:shadow-xl"
                          ><svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                          <path
                          ...
                          ></path></svg><span class="menu-sub-item-text">Analytics</span></a><a
                              href="#"
                              class="text-green-200 hover:bg-green-600 flex items-center py-5 px-4 rounded-xl hover:shadow-xl"
                          ><svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                          <path
                          ...
                          ></path></svg><span class="menu-sub-item-text">Inventory</span></a><a
                              href="#"
                              class="text-green-200 hover:bg-green-600 flex items-center py-5 px-4 rounded-xl hover:shadow-xl"
                          ><svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                          <path
                          ...
                          ></path></svg><span class="menu-sub-item-text">Products</span></a><a
                              href="#"
                              class="text-green-200 hover:bg-green-600 flex items-center py-5 px-4 rounded-xl hover:shadow-xl"
                          ><svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                          <path
                          ...
                          ></path></svg><span class="menu-sub-item-text">Settings</span></a>
              </nav>
              <main class="flex items-center justify-center w-full">
                  <h1 class="text-3xl text-gray-500 ">Insert content here</h1>
              </main>
          </div></>

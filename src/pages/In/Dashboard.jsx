      ...
      <div className="flex flex-col-reverse md:flex-row md:flex-wrap gap-8 my-16">
        <div className="flex-1 w-full md:max-w-[400px]">
          <div className="rounded-md px-4 md:px-12 py-4">
            ...
            <div className="mt-8 h-[200px] bg-[#F6F6F6]/[0.4] rounded-lg"></div>
          </div>
        </div>
        <div className="flex-1 w-full md:max-w-[400px]">
          <div className="bg-[#F6F6F6]/[0.4] rounded-lg px-4 md:px-12 py-4">
            <h3 className="text-xl font-bold">My library</h3>
            <div className="flex flex-col gap-1 mt-8">
              <NavLink to="/in/watch-later" className="px-5 py-3 rounded flex gap-4 items-center cursor-pointer hover:bg-white">

			...
			<section className="max-w-4xl ml-16 lg:ml-0">
				<header className="flex flex-gap items-center gap-6 justify-between">
					...
					<button
						...
						className="border border-[#E9E9E9] py-2 px-7 rounded-md"
					>
						Add Card
					</button>
				</header>
				...
				<div className="mt-20">
					...
					<div className="flex flex-wrap gap-8 mt-4">
						{pricing.map((plan) => (
							<div
								className="px-16 py-8 rounded-2xl afr-shadow cursor-pointer"
								key={plan.type}
							>
				...
				<div className="mt-4">
					<form className="mt-8 flex flex-col gap-6">
						<input
							...
							className="border border-[#E9E9E9] px-4 py-3 rounded-lg"
						/>
						...
						<input
							...
							className="border border-[#E9E9E9] px-4 py-3 rounded-lg"
						/>
						<button className="bg-[#07092C] text-white py-3 rounded-lg">
							Add Card
						</button>
					</form>
				</div>
